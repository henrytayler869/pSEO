...
/** Kỳ phủ của mọi adapter. Đọc từ lib/collector/vintages.ts — dựng adapter
 *  chỉ để hỏi một hằng số sẽ kéo `node:fs` vào bundle của trang. */
export { TEMPORAL_COVERAGE } from "@/lib/collector/vintages";
